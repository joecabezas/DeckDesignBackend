<div class="galleryCategories index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php //echo $this->Html->link(__('View', true), array('action' => 'view', $galleryCategory['GalleryCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $galleryCategory['GalleryCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $galleryCategory['GalleryCategory']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $galleryCategory['GalleryCategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
